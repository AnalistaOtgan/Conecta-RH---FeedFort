...
import { DashboardIcon, PlusCircleIcon, FileTextIcon, UsersIcon, LayersIcon, SettingsIcon, LogOutIcon } from './icons';
...
const Sidebar: React.FC = () => {
    ...
    return (
        <aside className="w-64 bg-white flex flex-col border-r border-brand-gray">
            <div className="h-20 flex items-center px-6 border-b border-brand-gray">
